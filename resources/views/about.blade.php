...
<section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Tentang FIKOM</h1>
        <p class="text-xl">Fakultas Ilmu Komputer Manajemen dan  USTJ - Mengembangkan Generasi Programmer Papua</p>
    </div>
</section>
