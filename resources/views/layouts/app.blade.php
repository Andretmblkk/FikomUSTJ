...
<head>
    ...
    <title>@yield('title', 'FIKOM - Fakultas Ilmu Komputer USTJ')</title>
    <meta name="description" content="@yield('description', 'Fakultas Ilmu Komputer USTJ Jayapura - Universitas Sains dan Teknologi Jayapura')">
    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-lg overflow-hidden">
                            <img src="{{ asset('images/logo_fakultas.png') }}" alt="Logo FIKOM USTJ" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <h1 class="text-xl font-bold text-gray-900">FIKOM</h1>
                            <p class="text-xs text-gray-600">Fakultas Ilmu Komputer dan Manajemen USTJ</p>
                        </div>
                    </a>
                </div>
                
                <div class="hidden md:flex items-center space-x-6">
                    <a href="{{ route('home') }}" class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('home') ? 'text-blue-600 bg-blue-50' : '' }}">Beranda</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                <a href="{{ route('home') }}" class="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('home') ? 'text-blue-600 bg-blue-50' : '' }}">Beranda</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold">FIKOM</h3>
                            <p class="text-sm text-gray-400">Fakultas Ilmu Komputer dan Manajemen USTJ</p>
                        </div>
                    </div>
                    <p class="text-gray-400 mb-4">Mengembangkan generasi programmer dan teknisi komputer yang kompeten dan berkarakter untuk masa depan digital Papua.</p>
                </div>
                
                <div>
                    <h4 class="text-lg font-semibold mb-4">Kontak</h4>
                    <div class="space-y-2 text-gray-400">
                        <p>📧 info@fikom.ustj.ac.id</p>
                        <p>📞 (0967) 123-4567</p>
                        <p>📍 Jl. Sosial Padang Bulan, Hedam<br>Kec. Abepura, Kota Jayapura<br>Papua 99352</p>
                    </div>
                </div>
            </div>
            
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} FIKOM - Fakultas Ilmu Komputer dan Manajemen USTJ Jayapura. All rights reserved.</p>
            </div>
        </div>
    </footer>
